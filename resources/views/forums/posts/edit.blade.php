...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6">
            ...
            <form action="{{ isset($isGroupPost) && $isGroupPost ? route('forums.groups.posts.update', ['group' => $group->slug, 'post' => $post->id]) : route('forums.posts.update', $post) }}" 
                  method="POST" 
                ...
                @if($post->media_path)
                    <div class="mb-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            @endif
                            <span class="text-sm text-gray-600">{{ $post->media_name }}</span>
                        </div>
                        <div class="mt-2">
                ...
                <div class="flex items-center justify-end space-x-3">
                    <a href="{{ isset($isGroupPost) && $isGroupPost ? route('forums.groups.show', $group->slug) : url()->previous() }}" 
                        ...
                        function handleFormSubmit(form) {
                            ...
                            .then(data => {
                                ...
                                if (data.success) {
                                    ...
                                    setTimeout(() => {
                                        window.location.href = form.redirect_to.value || '{{ url('/') }}';
                                    }, 1000);
                                }
                            })
                            .catch(error => {
